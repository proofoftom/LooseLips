    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-[600px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure a new AI agent to securely interact with your encrypted
            memories.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className='space-y-2'>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value='claude-3'>Claude 3.7</SelectItem>
                    <SelectItem value='gemini-pro'>Gemini Pro 2.5</SelectItem>
                    <SelectItem value='llama-3'>Llama 3.3</SelectItem>
              ...
              >
                <div className='flex items-start space-x-2 rounded-md border p-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Agent can read, write, and modify all memories without
                      restrictions
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-2 rounded-md border p-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Agent can read all memories but only modify specific
                      categories
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-2 rounded-md border p-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Agent can only read memories but cannot create or modify
                      them
                    </p>
                  </div>
                </div>
                        ...
                        <div className='flex items-center space-x-2'>
                          ...
                          <div>
                            ...
                            <p className='text-xs text-muted-foreground'>
                              Unstoppable intelligence network for agents
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <p className='text-sm text-muted-foreground'>
                Encrypt all memories with AES-256 before storing on{' '}
                {
                  storageProviders.find(
                    (p) => p.id === agentData.storageProvider
                  )?.name
                }
              </p>
            </div>
        ...
        <DialogFooter className='flex items-center justify-between'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            {step < 3 ? (
              <Button
                onClick={handleNext}
                disabled={step === 1 && !agentData.name}
              >
                Next
              </Button>
            ) : (
